...
public class GameWindow {
    ...
    /**
     * Display the score scene when game finishes
     * @param game the game used to pass in score information
     */
    public void startScore(Game game) {loadScene(new ScoresScene(this,game));}
    /**
     * Display the score scene for online game
     * @param game the Multiplayer game
     * @param scores Arraylist of all players' scores in a game
     */
    public void startOnlineScore(MultiplayerGame game, ArrayList scores){
        List<Triplet<String, String, String>> list = scores;
        loadScene(new OnlineScoreScene(this, game, list));}

    /**
     * Display the lobby scene
     */
    public void startMulti(){loadScene(new LobbyScene(this));}

    /**
     * Display the multiplayer game scene
     */
    public void startMultiGame(){loadScene(new MultiplayerScene(this));}
